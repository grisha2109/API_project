#чуть-чуть скорректировал шестую, т.к там плохо раюотало перемещение и не работал поиск при нажатии Enter
import sys
import urllib.request
from PyQt5.QtWidgets import QApplication, QMainWindow, QWidget, QVBoxLayout, QLineEdit, QPushButton, QLabel, QMessageBox, QComboBox
...
class MapViewer(QMainWindow):
    def __init__(self):
        ...
        self.search_field.returnPressed.connect(self.locate)  # Добавлено: Enter вызывает поиск
